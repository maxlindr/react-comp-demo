...
import DesktopDataPicker from '../DesktopDatePicker';
...
describe('DesktopDataPicker', () => {
  it('should initially render PickerTextField only', () => {
    const { queryByTestId } = render(<DesktopDataPicker />);
  ...
  it('toggle open/close picker controlled by toggle button', () => {
    ...
    const { container, queryByTestId } = render(
      <DesktopDataPicker toggleLabel="toggle-btn" />,
    );
  ...
  it('invokes onChange callback with selected date', () => {
    ...
    const { container, getAllByTestId } = render(
      <DesktopDataPicker toggleLabel="toggle-btn" onChange={onChange} />,
    );
